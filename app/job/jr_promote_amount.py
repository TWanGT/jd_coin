...
class baitiao(Daka):
    ...
    sign_url = 'https://ms.jr.jd.com/gw/generic/bt/na/m/receiveDailyQuotaPackage'
    ...
    def get_sign_data(self):
        ...
        try:
            ...
            if 'resultData' in as_json:
                ...
                self.logger.error('获取白条提额数据失败: {}'.format(error_msg))

        except Exception as e:
            self.logger.error('获取白条提额数据失败: {}'.format(e))
    ...
    def is_signed(self):
        ...
        try:
            ...
            self.logger.info('今日已白条提额: {}'.format(signed))

        except Exception as e:
            self.logger.error('返回数据结构可能有变化, 获取白条提额数据失败: {}'.format(e))
            traceback.print_exc()
    ...
    def sign(self):
        ...
        self.logger.info('白条提额成功: {}; Message: {}'.format(sign_success, message))
